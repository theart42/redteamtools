...
__author__ = "theart42, based on bones7456"
__home_page__ = "https://t42.1secure.nl/"
...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    server_version = "simpleserver/" + __version__
...
#    http.server.test(HandlerClass, ServerClass)
    httpd = HTTPServer(('192.168.49.117', 80), SimpleHTTPRequestHandler)
